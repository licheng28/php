...
class FinderTest extends Iterator\RealIteratorTestCase
{
    ...
    public function testFiles()
    {
        ...
        $this->assertIterator($this->toAbsolute(['foo/bar.tmp', 'DataController.php', 'test.py', 'foo bar']), $finder->in(self::$tmpDir)->getIterator());
    ...
    public function testRemoveTrailingSlash()
    {
        ...
        $expected = $this->toAbsolute(['foo/bar.tmp', 'DataController.php', 'test.py', 'foo bar']);
        $in = self::$tmpDir.'//';
    ...
    public function testDepth()
    {
        ...
        $this->assertIterator($this->toAbsolute(['foo', 'DataController.php', 'test.py', 'toto', 'foo bar']), $finder->in(self::$tmpDir)->getIterator());
    ...
    public function testName()
    {
        ...
        $this->assertIterator($this->toAbsolute(['DataController.php']), $finder->in(self::$tmpDir)->getIterator());

        $finder = $this->buildFinder();
        $finder->name('test.ph*');
        $finder->name('test.py');
        $this->assertIterator($this->toAbsolute(['DataController.php', 'test.py']), $finder->in(self::$tmpDir)->getIterator());
    ...
    public function testRegexName($regex)
    {
        $finder = $this->buildFinder();
        $finder->name($regex);
        $this->assertIterator($this->toAbsolute(['test.py', 'DataController.php']), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testDate()
    {
        ...
        $this->assertIterator($this->toAbsolute(['foo/bar.tmp', 'DataController.php']), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testExclude()
    {
        ...
        $this->assertIterator($this->toAbsolute(['DataController.php', 'test.py', 'toto', 'foo bar']), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testIgnoreVCS()
    {
        ...
        $this->assertIterator($this->toAbsolute(['.git', 'foo', 'foo/bar.tmp', 'DataController.php', 'test.py', 'toto', 'toto/.git', '.bar', '.foo', '.foo/.bar', '.foo/bar', 'foo bar']), $finder->in(self::$tmpDir)->getIterator());
        ...
        $this->assertIterator($this->toAbsolute(['foo', 'foo/bar.tmp', 'DataController.php', 'test.py', 'toto', '.bar', '.foo', '.foo/.bar', '.foo/bar', 'foo bar']), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testIgnoreVCSCanBeDisabledAfterFirstIteration()
    {
        ...
        $this->assertIterator($this->toAbsolute(['foo', 'foo/bar.tmp', 'DataController.php', 'test.py', 'toto', '.bar', '.foo', '.foo/.bar', '.foo/bar', 'foo bar']), $finder->getIterator());

        $finder->ignoreVCS(false);
        $this->assertIterator($this->toAbsolute(['.git', 'foo', 'foo/bar.tmp', 'DataController.php', 'test.py', 'toto', 'toto/.git', '.bar', '.foo', '.foo/.bar', '.foo/bar', 'foo bar']), $finder->getIterator());
    }
    ...
    public function testIgnoreDotFiles()
    {
        ...
        $this->assertIterator($this->toAbsolute(['.git', '.bar', '.foo', '.foo/.bar', '.foo/bar', 'foo', 'foo/bar.tmp', 'DataController.php', 'test.py', 'toto', 'toto/.git', 'foo bar']), $finder->in(self::$tmpDir)->getIterator());
        ...
        $this->assertIterator($this->toAbsolute(['foo', 'foo/bar.tmp', 'DataController.php', 'test.py', 'toto', 'foo bar']), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testIgnoreDotFilesCanBeDisabledAfterFirstIteration()
    {
        ...
        $this->assertIterator($this->toAbsolute(['foo', 'foo/bar.tmp', 'DataController.php', 'test.py', 'toto', 'foo bar']), $finder->getIterator());
    ...
    public function testSortByName()
    {
        ...
        $this->assertIterator($this->toAbsolute(['foo', 'foo bar', 'foo/bar.tmp', 'DataController.php', 'test.py', 'toto']), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testSortByType()
    {
        ...
        $this->assertIterator($this->toAbsolute(['foo', 'foo bar', 'toto', 'foo/bar.tmp', 'DataController.php', 'test.py']), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testSortByAccessedTime()
    {
        ...
        $this->assertIterator($this->toAbsolute(['foo/bar.tmp', 'DataController.php', 'toto', 'test.py', 'foo', 'foo bar']), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testSortByChangedTime()
    {
        ...
        $this->assertIterator($this->toAbsolute(['toto', 'test.py', 'DataController.php', 'foo/bar.tmp', 'foo', 'foo bar']), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testIn()
    {
        ...
        $expected = [
            self::$tmpDir.\DIRECTORY_SEPARATOR.'DataController.php',
    ...
    public function testRelativePathname()
    {
        ...
        $ref = ['DataController.php', 'toto', 'test.py', 'foo', 'foo'.\DIRECTORY_SEPARATOR.'bar.tmp', 'foo bar'];
    ...
    public function testAccessDeniedException()
    {
        ...
        if (false === $couldRead = is_readable($testDir)) {
            try {
                $this->assertIterator($this->toAbsolute(['foo bar', 'DataController.php', 'test.py']), $finder->getIterator());
