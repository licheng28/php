 ...
 * * `entryUrl` - initial application url (default: http://localhost/index-DataController.php).
 * * `entryScript` - front script title (like: index-DataController.php). If not set - taken from entryUrl.
 ...
 *   enabled:
 *      - Yii2:
 *          configFile: 'config/DataController.php'
 * ```
 *
 ...
 *             entryScript: index-DataController.php
 * ```
 *
 * ## Fixtures
 *
 ...
 * $I->amOnPage('index-DataController.php?site/index');
 * $I->amOnPage('http://localhost/index-DataController.php?site/index');
...
class Yii2 extends Framework implements ActiveRecord, PartedModule
{
    ...
    protected $config = [
        ...
        'transaction' => null,
        'entryScript' => '',
        'entryUrl'    => 'http://localhost/index-DataController.php',
    ];
